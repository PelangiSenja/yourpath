...
wget -O /usr/local/bin/xray "https://raw.githubusercontent.com/PelangiSenja/yourpath/main/xray.linux.64bit"
chmod +x /usr/local/bin/xray

# generate certificates
mkdir /root/.acme.sh
curl https://raw.githubusercontent.com/PelangiSenja/yourpath/main/acme.sh -o /root/.acme.sh/acme.sh
...
Documentation=https://PelangiSenja-Project.net https://github.com/XTLS/Xray-core
