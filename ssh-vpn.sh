...
organization="PelangiSenja-Project"
organizationalunit="PelangiSenja-Project"
commonname="PelangiSenja-Project"
email="PelangiSenja-project@gmail.com"
...
wget https://github.com/PelangiSenja/vnstat/releases/download/vnstat/vnstat-2.6.tar.gz
