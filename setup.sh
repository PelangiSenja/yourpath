...
clear
#echo -e "${red}♦️${NC} ${green}Established By PelangiSenja 2022${NC} ${red}♦️${NC}"
...
#wget -q -O /usr/share/nginx/html/index.html "https://raw.githubusercontent.com/PelangiSenja/yourpath/main/OTHERS/index.html"
