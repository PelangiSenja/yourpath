...
vmess_req() {
    ...
    echo -e "\e[36m╘═══════════════════════════════════════════╛\033[0m"
    echo -e "\033[1;37mWSS Converter By PelangiSenja\033[0m"
    echo -e "\033[1;37mTelegram : https://t.me/PelangiSenja / @todfix667\033[0m"
    echo ""
    echo -e "[1] Digi"
    echo -e "[2] Maxis"
    echo -e "[3] Celcom"
...
EOF
    ...
    echo -e ""
    echo -e "Autoscript By PelangiSenja"
    echo -e ""
